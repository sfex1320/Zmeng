	...
	> => {
		...
		const menu = await Menu.new({
			...
			items: [
				...
				{
					id: `${appWindow.label}-clipboard-sidebar`,
					text: intl.formatMessage({ id: "home.clipboardSidebar" }),
					accelerator: disableShortcut
						? undefined
						: formatKey(shortcutKeys[AppFunction.ClipboardSidebar].shortcutKey),
					action: async () => {
				...
				{
					id: `${appWindow.label}-open-settings`,
					text: "设置",
					action: async () => {
						showWindow();
						openSettings();
