...
export const defaultAppSettingsData: AppSettingsData = {
	[AppSettingsGroup.Common]: {
		...
		themePreset: AppSettingsThemePreset.SkyBlue,
		mainColor: "#1677FF",
		borderRadius: 8,
...
4. Visual structure preservation`,
	...
	[AppSettingsGroup.FunctionOutput]: {
		manualSaveFileNameFormat: `ZMENG_{{YYYY-MM-DD_HH-mm-ss}}`,
		autoSaveFileNameFormat: `ZMENG_{{YYYY-MM-DD_HH-mm-ss}}`,
		fastSaveFileNameFormat: `ZMENG_{{YYYY-MM-DD_HH-mm-ss}}`,
		focusedWindowFileNameFormat: `${FOCUS_WINDOW_APP_NAME_ENV_VARIABLE}/ZMENG_{{YYYY-MM-DD_HH-mm-ss}}`,
		fullScreenFileNameFormat: `ZMENG_{{YYYY-MM-DD_HH-mm-ss}}`,
		videoRecordFileNameFormat: `ZMENG_Video_{{YYYY-MM-DD_HH-mm-ss}}`,
		uploadToCloudSaveUrlFormat: `ZMENG_{{YYYY-MM-DD_HH-mm-ss}}`,
	},
