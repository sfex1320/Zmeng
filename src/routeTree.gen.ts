...
const LayoutSettingsCatLazyRouteImport = createFileRoute(
  '/_layout/settings/$cat',
)()
...
const NoLayoutClipboardSidebarLazyRoute =
  NoLayoutClipboardSidebarLazyRouteImport.update({
    id: '/clipboardSidebar',
    path: '/clipboardSidebar',
    getParentRoute: () => NoLayoutRouteRoute,
  } as any).lazy(() =>
...
const LayoutSettingsIndexLazyRoute = LayoutSettingsIndexLazyRouteImport.update({
  id: '/settings/',
  path: '/settings/',
  getParentRoute: () => LayoutRouteRoute,
} as any).lazy(() =>
...
const LayoutSettingsCatLazyRoute = LayoutSettingsCatLazyRouteImport.update({
  id: '/settings/$cat',
  path: '/settings/$cat',
  getParentRoute: () => LayoutRouteRoute,
} as any).lazy(() =>
  import('./routes/_layout/settings/$cat.lazy').then((d) => d.Route),
)
...
export interface FileRoutesByFullPath {
  ...
  '/settings/$cat': typeof LayoutSettingsCatLazyRoute
...
export interface FileRoutesById {
  ...
  '/_layout/settings/$cat': typeof LayoutSettingsCatLazyRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_noLayout/clipboardSidebar': {
      id: '/_noLayout/clipboardSidebar'
      path: '/clipboardSidebar'
      fullPath: '/clipboardSidebar'
    ...
    '/_layout/settings/': {
      ...
      path: '/settings'
      fullPath: '/settings'
      preLoaderRoute: typeof LayoutSettingsIndexLazyRouteImport
      parentRoute: typeof LayoutRouteRoute
    }
    '/_layout/tools/translation': {
    ...
    '/_layout/settings/$cat': {
      id: '/_layout/settings/$cat'
      path: '/settings/$cat'
      fullPath: '/settings/$cat'
      preLoaderRoute: typeof LayoutSettingsCatLazyRouteImport
      parentRoute: typeof LayoutRouteRoute
    }
    '/_layout/personalization/plugins': {
...
interface LayoutRouteRouteChildren {
  ...
  LayoutSettingsCatLazyRoute: typeof LayoutSettingsCatLazyRoute
...
const LayoutRouteRouteChildren: LayoutRouteRouteChildren = {
  ...
  LayoutSettingsCatLazyRoute: LayoutSettingsCatLazyRoute,
...
interface NoLayoutRouteRouteChildren {
  NoLayoutClipboardSidebarLazyRoute: typeof NoLayoutClipboardSidebarLazyRoute
...
const NoLayoutRouteRouteChildren: NoLayoutRouteRouteChildren = {
  NoLayoutClipboardSidebarLazyRoute: NoLayoutClipboardSidebarLazyRoute,
